...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white pb-12 pt-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">
          Privacy Policy
        </h1>

        <p className="text-gray-600 mb-8">Last updated: August 12, 2025</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li className="text-gray-600">
            ...
            "Us" or "Our" in this Agreement) refers to SUPER MARINE MOTOR CYCLES
            & JET SKI L.L.C., 9GC9+X65 - Mussaffah - M3 Abu Dhabi - United Arab
            Emirates.
          </li>
          <li className="text-gray-600">
          ...
          <li className="text-gray-600">
            <strong>Website</strong> refers to supermarinerental.com, accessible
            from
            <a
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li className="text-gray-600">First name and last name</li>
          <li className="text-gray-600">Phone number</li>
          <li className="text-gray-600">
            Address, State, Province, ZIP/Postal code, City
          </li>
          <li className="text-gray-600">Usage Data</li>
        </ul>
        ...
        <p className="text-gray-600 mb-2">Type: Session Cookies</p>
        <p className="text-gray-600 mb-2">Administered by: Us</p>
        <p className="text-gray-600 mb-6">
        ...
        <p className="text-gray-600 mb-2">Type: Persistent Cookies</p>
        <p className="text-gray-600 mb-2">Administered by: Us</p>
        <p className="text-gray-600 mb-6">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li className="text-gray-600">Comply with a legal obligation</li>
          <li className="text-gray-600">
          ...
          <li className="text-gray-600">Protect against legal liability</li>
        </ul>
